Public Class HasQuarterState
    ...
    Private m_randomWinner As New Random(DateTime.Now.Millisecond)
    ...
    Public Sub TurnCrank() Implements IState.TurnCrank
        ...
        Dim winner As Integer = m_randomWinner.Next(10)
        If winner = 0 And m_machine.Count > 1 Then
            m_machine.State = m_machine.WinnerState
        Else
